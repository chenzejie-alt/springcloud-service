...
//        int age = 1 / 0;
    ...
    public String paymentInfo_TimeOutHandler(Integer id) {
        return "线程池：" + Thread.currentThread().getName() + "，8001系统忙或者运行报错，请稍后再试，paymentInfo_TimeOutHandler，id = " + id + "\t" + "o(╥﹏╥)o";
    }
    ...
    public String paymentCircuitBreaker(@PathVariable("id") Integer id) {
        ...
        return Thread.currentThread().getName() + "\t" + "调用成功，流水号为："+serialNumber+"，id = " + id;
    }
